...
class SSD1351 : public SPITFT {
  public:
    ...
    SSD1351(uint16_t width, uint16_t height, int8_t cs_pin,
    ...
    SSD1351(int8_t cs_pin, int8_t dc_pin, int8_t mosi_pin,
      int8_t sclk_pin, int8_t rst_pin = -1);
    // 2-3 args using default hardware SPI peripheral (reset optional)
    SSD1351(int8_t cs_pin, int8_t dc_pin, int8_t rst_pin = -1);

    virtual ~SSD1351(void);
