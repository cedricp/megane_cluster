...
SSD1351::SSD1351(uint16_t width, uint16_t height,
  ...
  int8_t rst_pin) : SPITFT(width, height, cs_pin, dc_pin,
...
#if defined(ESP8266)
  SPITFT(width, height, cs_pin, dc_pin, rst_pin) {
#else
  SPITFT(width, height, spi, cs_pin, dc_pin, rst_pin) {
#endif
}
...
/*!
    ...
    @note    Call the object's begin() function before use.
*/
SSD1351::SSD1351(int8_t cs_pin, int8_t dc_pin,
  int8_t mosi_pin, int8_t sclk_pin, int8_t rst_pin) :
  SPITFT(SSD1351WIDTH, SSD1351HEIGHT, cs_pin, dc_pin, mosi_pin,
  sclk_pin, rst_pin, -1) {
}
...
/*!
    ...
    @note    Call the object's begin() function before use.
*/
SSD1351::SSD1351(int8_t cs_pin, int8_t dc_pin, int8_t rst_pin) :
#if defined(ESP8266)
  SPITFT(SSD1351WIDTH, SSD1351HEIGHT, cs_pin, dc_pin, rst_pin)
#else
  SPITFT(SSD1351WIDTH, SSD1351HEIGHT, &SPI, cs_pin, dc_pin, rst_pin)
#endif
{ }
...
/*!
    ...
    @return  None (void).
*/
void SSD1351::begin(uint32_t freq) {
 ...
 */
/**************************************************************************/
void SSD1351::enableDisplay(boolean enable) {
